      ...
      <Container>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5">
          ...
          <motion.div
            ...
            className="group relative h-[360px] sm:h-[400px] rounded-3xl p-6 flex flex-col justify-between bg-gradient-to-br from-[#fff7ed]/80 via-[#fef2f2]/60 to-[#f1f5f9] border border-red-100/80 shadow-md hover:shadow-2xl transition-all duration-300"
          >
            {/* Top Row */}
