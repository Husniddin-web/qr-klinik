...
export function AboutSection() {
  ...
  // Layered vertical parallax translations with varied depths
  const yLayer1 = useTransform(smoothProgress, [0, 1], [-25, 25]);
  const yLayer2 = useTransform(smoothProgress, [0, 1], [40, -40]);
  const yLayer3 = useTransform(smoothProgress, [0, 1], [-18, 28]);
    ...
    >
      <Container>
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-14 xl:gap-20 items-center">
          ...
          {/* Right Column: Handcrafted Asymmetric Multi-Photo Layered Composition with 3D Parallax */}
          <div
            data-aos="fade-left"
            data-aos-duration="850"
          ...
          >
            <div className="relative w-full max-w-[620px] mx-auto lg:ml-auto h-[420px] sm:h-[500px] lg:h-[540px]">
              ...
              <motion.div
                ...
                data-aos-delay="100"
                data-aos-duration="850"
                className="absolute top-0 right-0 w-[86%] sm:w-[82%] h-[68%] sm:h-[72%] rounded-3xl sm:rounded-[32px] overflow-hidden shadow-[0_20px_45px_rgba(15,23,42,0.12)] border border-slate-200/60 group will-change-transform"
              >
                <Image
                  src="/on-section.jpg"
              ...
              <motion.div
                ...
                data-aos-delay="250"
                data-aos-duration="850"
                className="absolute bottom-0 left-0 w-[64%] sm:w-[58%] h-[48%] sm:h-[52%] rounded-2xl sm:rounded-[26px] overflow-hidden shadow-[0_25px_50px_rgba(15,23,42,0.22)] border-[5px] sm:border-[6px] border-white z-20 group will-change-transform"
              >
                <Image
              ...
              <motion.div
                ...
                data-aos-delay="350"
                data-aos-duration="850"
                className="hidden sm:block absolute top-8 sm:top-10 -left-4 sm:-left-6 w-[34%] h-[44%] rounded-2xl sm:rounded-[24px] overflow-hidden shadow-[0_20px_40px_rgba(15,23,42,0.18)] border-[5px] sm:border-[6px] border-white z-10 group will-change-transform"
              >
                <Image
