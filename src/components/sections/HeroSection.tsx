...
export function HeroSection({ onOpenAppointment }: HeroSectionProps) {
  ...
  return (
    ...
    >
      ...
      {/* Top-Right Handwritten Script Note: High-contrast Deep Navy & Crimson Accent */}
      <div
        data-aos="fade-left"
        data-aos-delay="450"
      ...
      <div className="relative z-10 w-full px-6 sm:px-10 md:px-14 lg:px-16 xl:px-24 2xl:px-32">
        <div className="max-w-xl lg:max-w-2xl xl:max-w-[700px] flex flex-col items-start">
          ...
          <div
            ...
            className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#fef2f2] border border-[#fecaca] text-[#dc2626] text-xs sm:text-sm font-semibold mb-4 sm:mb-6 shadow-sm"
          >
            <Heart className="w-4 h-4 text-[#dc2626]" />
            <span>{t("badge")}</span>
          </div>

          {/* Headline: Strictly 2 lines in both locales */}
          <h1
            data-aos="fade-up"
            data-aos-delay="200"
          ...
          <p
            ...
            data-aos-delay="300"
            data-aos-duration="850"
            className="mt-4 sm:mt-6 text-base sm:text-lg lg:text-xl text-slate-600 leading-relaxed font-normal max-w-lg"
          >
            {t("subtitle")}
          </p>
