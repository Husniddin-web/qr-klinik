  ...
  return (
    ...
    >
      ...
      <Container className="relative z-10">
        ...
        {/* 3-Column Luxury Card Grid with 3D Tilt & Specular Sheen */}
            ...
            return (
              ...
              >
                <TiltCard
                  ...
                  maxTilt={6}
                  glare={true}
                  className="group cursor-pointer rounded-2xl sm:rounded-[22px] p-5 sm:p-6 transition-colors duration-200 flex flex-col justify-between h-full bg-white/95 border border-slate-200/80 shadow-[0_4px_20px_rgba(15,23,42,0.03)] hover:shadow-[0_20px_40px_rgba(220,38,38,0.12)] hover:border-red-200 backdrop-blur-md overflow-hidden"
                >
                  <div>
