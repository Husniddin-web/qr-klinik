...
const STATUS_META: Record<LeadStatus, { label: string; cls: string; dot: string }> = {
  new: { label: "Yangi", cls: "bg-red-50 text-accent border-red-200", dot: "bg-accent" },
                    ...
                    <tr key={item._id} className="hover:bg-slate-50/80 transition-colors align-top">
                      <td className="py-3 px-4 sm:px-6">
                        ...
                        <a
                          ...
                          className="inline-flex items-center gap-1 text-[11px] font-mono text-slate-500 hover:text-accent mt-0.5"
                        >
                      ...
                      <td className="py-3 px-4 sm:px-6 text-right">
                        <button
                          ...
                          className="w-8 h-8 rounded-lg border border-slate-200 hover:bg-red-50 hover:border-red-200 inline-flex items-center justify-center text-slate-400 hover:text-accent transition-colors"
                          title="O'chirish"
                        >
